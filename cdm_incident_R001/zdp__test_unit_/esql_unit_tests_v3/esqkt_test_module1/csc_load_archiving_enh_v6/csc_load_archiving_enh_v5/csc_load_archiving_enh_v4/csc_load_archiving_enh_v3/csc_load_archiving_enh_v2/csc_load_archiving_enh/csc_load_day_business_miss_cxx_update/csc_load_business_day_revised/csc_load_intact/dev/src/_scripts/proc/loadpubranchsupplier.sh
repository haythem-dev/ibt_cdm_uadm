...
#set -v
 ...
 #Creation-Type:                                                                        
 #Purpose:           Starts, stops and status the exemplar binary loadpubranchsupplier.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadpubranchsupplier.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadpubranchsupplier.option
...
. $(dirname $0)/../vars/loadpubranchsupplier.vars;
