#! /usr/bin/ksh
 ...
 #Creation-Time:     17:54                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary tpldagp for presentation only.               
 ###############################################################################################
