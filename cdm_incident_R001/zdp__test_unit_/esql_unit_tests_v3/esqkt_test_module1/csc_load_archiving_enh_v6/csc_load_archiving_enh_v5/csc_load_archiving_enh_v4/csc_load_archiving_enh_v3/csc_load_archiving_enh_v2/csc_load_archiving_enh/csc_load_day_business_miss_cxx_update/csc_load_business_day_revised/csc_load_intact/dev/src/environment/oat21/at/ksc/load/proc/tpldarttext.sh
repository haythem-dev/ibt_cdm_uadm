#! /usr/bin/ksh
 ...
 #Creation-Time:	14:58
 #Purpose:			starts, stops and status the exemplar binary tpldarttext for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=tpldarttext.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "22.09.08 14:58:07"; fi
 ...
 . $(dirname $0)/../vars/tpldarttext.vars;
