#! /usr/bin/ksh
 ...
 #Creation-Time:	14:59
 #Purpose:			starts, stops and status the exemplar binary tpldean for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "10.10.08 14:59:48"; fi
