#! /usr/bin/ksh
 ...
 #Creation-Time:	17:49
 #Purpose:			starts, stops and status the exemplar binary loadpharmgrp for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 17:49:36"; fi
 ...
 . $(dirname $0)/../vars/loadpharmgrp.vars;
