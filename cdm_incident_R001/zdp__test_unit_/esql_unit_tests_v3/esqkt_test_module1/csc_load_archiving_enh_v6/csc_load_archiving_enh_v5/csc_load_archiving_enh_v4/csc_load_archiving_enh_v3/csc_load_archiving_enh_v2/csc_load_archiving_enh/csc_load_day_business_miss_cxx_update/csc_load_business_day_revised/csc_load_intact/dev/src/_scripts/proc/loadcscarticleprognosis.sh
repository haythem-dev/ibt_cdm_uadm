...
#set -v
 ...
 #Creation-Time:     11:37                                                                                     
 #Creator:           generate_proc_file                                               
 #Creation-Type:                                                                        
 #Purpose:           Starts, stops and status the exemplar binary loadcscarticleprognosis.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcscarticleprognosis.bin
 ...
 function assembling_process
 {
	 local _parameters="";
 	 ...
 	 if (( ${#_parameters} > 0 )); then
 		 _parameters="${_parameters} $VZ_OPTION $branchno"
 	 else
 		 _parameters="$VZ_OPTION $branchno";
 	 fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadcscarticleprognosis.option
...
. $(dirname $0)/../vars/loadcscarticleprognosis.vars;
