#! /usr/bin/ksh
 ...
 #Creation-Time:     16:12                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadpayterm for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadpayterm.bin
...
# 	 fi
 ...
 . $(dirname $0)/../vars/loadpayterm.vars;
