#! /usr/bin/ksh
 ...
 #Creation-Time:	17:56
 #Purpose:			starts, stops and status the exemplar binary loadrange for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 17:56:20"; fi
