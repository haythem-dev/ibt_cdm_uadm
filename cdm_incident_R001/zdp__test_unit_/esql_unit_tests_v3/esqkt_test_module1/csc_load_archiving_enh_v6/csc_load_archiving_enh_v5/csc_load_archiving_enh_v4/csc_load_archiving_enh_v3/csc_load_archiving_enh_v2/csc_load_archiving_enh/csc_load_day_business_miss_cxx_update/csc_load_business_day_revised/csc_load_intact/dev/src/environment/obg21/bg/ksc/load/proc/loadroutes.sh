#! /usr/bin/ksh
 ...
 #Creation-Time:	13:16
 #Purpose:			starts, stops and status the exemplar binary loadroutes for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadroutes.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "04.09.08 13:16:33"; fi
 ...
 . $(dirname $0)/../vars/loadroutes.vars;
