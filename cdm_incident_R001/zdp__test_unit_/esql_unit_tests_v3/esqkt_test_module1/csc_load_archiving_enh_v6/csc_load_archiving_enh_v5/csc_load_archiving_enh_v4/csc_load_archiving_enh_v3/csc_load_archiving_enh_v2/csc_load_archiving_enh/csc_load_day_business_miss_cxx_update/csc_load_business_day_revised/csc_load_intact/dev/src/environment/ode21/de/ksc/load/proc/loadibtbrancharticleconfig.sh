#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadibtbrancharticleconfig for presentation only.
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadibtbrancharticleconfig.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadibtbrancharticleconfig.option
 ...
 . $(dirname $0)/../vars/loadibtbrancharticleconfig.vars;
