#! /usr/bin/ksh
 ...
 #Creation-Time:	18:31
 #Purpose:			starts, stops and status the exemplar binary loadsupport for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadsupport.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 18:31:24"; fi
 ...
 . $(dirname $0)/../vars/loadsupport.vars;
