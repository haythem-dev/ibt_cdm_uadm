#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loaddktmd for presentation only.             
 ###############################################################################################
