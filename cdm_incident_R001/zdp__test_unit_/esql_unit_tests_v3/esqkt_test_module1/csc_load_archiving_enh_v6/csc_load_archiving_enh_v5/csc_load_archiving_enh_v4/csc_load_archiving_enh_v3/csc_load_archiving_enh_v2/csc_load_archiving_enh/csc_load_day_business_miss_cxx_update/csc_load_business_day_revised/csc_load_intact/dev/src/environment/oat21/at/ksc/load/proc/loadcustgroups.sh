#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadcustgroups for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcustgroups.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadcustgroups.option
 ...
 . $(dirname $0)/../vars/loadcustgroups.vars;
