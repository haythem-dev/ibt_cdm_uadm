#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadreturnperiods for presentation only.     
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadreturnperiods.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadreturnperiods.option
 ...
 . $(dirname $0)/../vars/loadreturnperiods.vars;
