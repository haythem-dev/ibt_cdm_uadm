#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadcstcalcavp for presentation only.            
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcstcalcavp.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadcstcalcavp.option
 ...
 . $(dirname $0)/../vars/loadcstcalcavp.vars;
 ...
 #======================================================#
 if [[ "$start" == "YES" ]]; then
dbx $WSS/bg/ksc/load/bin/loadcstcalcavp.bin 
#-dg -file /home_dos/prj/df/unix/loadcstcalcavp/abc -db zpos3bg@db1_zdev1_shm -branchno 23
