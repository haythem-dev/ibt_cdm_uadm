#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadimexpermission for presentation only.    
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadimexpermission.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadimexpermission.option
 ...
 . $(dirname $0)/../vars/loadimexpermission.vars;
