#! /usr/bin/ksh
 ...
 #Creation-Time:     19:06                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loaddealvol for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loaddealvol.bin
...
# 	 fi
 ...
 . $(dirname $0)/../vars/loaddealvol.vars;
