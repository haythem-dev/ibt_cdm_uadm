#! /usr/bin/ksh
 ...
 #Creation-Time:	17:46
 #Purpose:			starts, stops and status the exemplar binary tpldanrufplan for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=tpldanrufplan.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 17:46:44"; fi
...
# 	 fi
 ...
 ###############################################################################################
 . $(dirname $0)/tpldanrufplan.option
 ...
 . $(dirname $0)/../vars/tpldanrufplan.vars;
