###############################################################################################
 # HEADER-DATA 
 ###############################################################################################
 #Author: 			Daniel Leprich 
 #Creation-Date:	11.02.2014
 #Creation-Time:	15:00
 #Purpose:			starts, stops and status the exemplar binary csc_deleteInactiveUsers for presentation only
 ###############################################################################################
 ...
 readonly BINARY=csc_deleteInactiveUsers.bin
 ...
 ###############################################################################################
 . $(dirname $0)/csc_deleteInactiveUsers.option
