#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary unlock_cucosbulgaria_for_salesweb for presentation only.
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=unlock_cucosbulgaria_for_salesweb._sh
 ...
 ###############################################################################################
 . $(dirname $0)/unlock_cucosbulgaria_for_salesweb.option
