#! /usr/bin/ksh
 ...
 #Creation-Time:	14:42
 #Purpose:			starts, stops and status the exemplar binary tpldvseauftrag for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=tpldvseauftrag.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 14:42:11"; fi
...
# 	 fi
 ...
 ###############################################################################################
 . $(dirname $0)/tpldvseauftrag.option
 ...
 . $(dirname $0)/../vars/tpldvseauftrag.vars;
