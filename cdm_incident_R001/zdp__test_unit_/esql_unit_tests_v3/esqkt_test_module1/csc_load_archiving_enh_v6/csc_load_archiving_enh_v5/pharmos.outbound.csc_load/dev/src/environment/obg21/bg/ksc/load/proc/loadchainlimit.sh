#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadchainlimit for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadchainlimit.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadchainlimit.option
 ...
 . $(dirname $0)/../vars/loadchainlimit.vars;
