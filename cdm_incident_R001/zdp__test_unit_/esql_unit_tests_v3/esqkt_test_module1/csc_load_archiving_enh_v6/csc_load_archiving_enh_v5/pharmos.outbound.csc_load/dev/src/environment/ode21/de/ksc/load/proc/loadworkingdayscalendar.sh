#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loaddkkaa for presentation only.
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadworkingdayscalendar.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadworkingdayscalendar.option
 ...
 . $(dirname $0)/../vars/loadworkingdayscalendar.vars;
