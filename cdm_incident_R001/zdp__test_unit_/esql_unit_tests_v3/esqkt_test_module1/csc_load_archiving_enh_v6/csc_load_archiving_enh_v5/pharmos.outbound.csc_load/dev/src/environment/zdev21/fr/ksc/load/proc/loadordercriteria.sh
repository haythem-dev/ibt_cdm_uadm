#! /usr/bin/ksh
 ...
 #Creation-Time:	15:42
 #Purpose:			starts, stops and status the exemplar binary loadordercriteria for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 15:42:18"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadordercriteria.option
 ...
 . $(dirname $0)/../vars/loadordercriteria.vars;
