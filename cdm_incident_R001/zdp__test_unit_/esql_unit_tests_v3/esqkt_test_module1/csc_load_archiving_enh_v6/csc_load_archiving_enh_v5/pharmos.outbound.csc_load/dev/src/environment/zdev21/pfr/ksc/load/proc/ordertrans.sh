#! /usr/bin/ksh
 ...
 #Creation-Time:	18:13
 #Purpose:			starts, stops and status the exemplar binary ordertrans for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 18:13:35"; fi
 ...
 . $(dirname $0)/../vars/ordertrans.vars;
