#! /usr/bin/ksh
 ...
 #Creation-Time:	18:21
 #Purpose:			starts, stops and status the exemplar binary loadcstpharmgrp for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcstpharmgrp.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 18:21:45"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadcstpharmgrp.option
 ...
 . $(dirname $0)/../vars/loadcstpharmgrp.vars;
