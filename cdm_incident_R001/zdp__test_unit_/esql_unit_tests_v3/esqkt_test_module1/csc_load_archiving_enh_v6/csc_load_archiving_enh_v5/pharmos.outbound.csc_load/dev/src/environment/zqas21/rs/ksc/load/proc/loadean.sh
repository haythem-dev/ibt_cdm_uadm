#! /usr/bin/ksh
 ...
 #Creation-Time:	15:19
 #Purpose:			starts, stops and status the exemplar binary loadean for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 15:19:29"; fi
