#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary delartikelkonto for presentation only.       
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=delartikelkonto.bin
 ...
 ###############################################################################################
 . $(dirname $0)/delartikelkonto.option
 ...
 . $(dirname $0)/../vars/delartikelkonto.vars;
