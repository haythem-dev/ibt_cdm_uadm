 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for LONGTERMLACKLOADER
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "longtermlackloaderapplctrl.h"
#include "componentmanager/longtermlackloaderinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<longtermlackloader::ApplCtrlImpl>::InstancePtr& Singleton<longtermlackloader::ApplCtrlImpl>::inst()
        {
