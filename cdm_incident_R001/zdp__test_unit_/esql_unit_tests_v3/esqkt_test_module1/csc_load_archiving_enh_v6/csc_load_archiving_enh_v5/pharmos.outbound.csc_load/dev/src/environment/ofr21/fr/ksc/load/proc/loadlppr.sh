#! /usr/bin/ksh
 ...
 #Creation-Time:	15:33
 #Purpose:			starts, stops and status the exemplar binary loadlppr for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 15:33:27"; fi
