#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadarticlelppr for presentation only.       
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadarticlelppr.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadarticlelppr.option
 ...
 . $(dirname $0)/../vars/loadarticlelppr.vars;
