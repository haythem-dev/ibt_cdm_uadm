#! /usr/bin/ksh
 ...
 #Creation-Time:	15:31
 #Purpose:			starts, stops and status the exemplar binary tplddrnat for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "19.09.08 15:31:37"; fi
