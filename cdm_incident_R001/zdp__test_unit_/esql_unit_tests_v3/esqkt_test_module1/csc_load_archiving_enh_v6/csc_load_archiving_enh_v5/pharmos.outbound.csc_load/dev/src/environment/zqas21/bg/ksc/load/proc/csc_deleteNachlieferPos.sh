###############################################################################################
 ...
 #Creation-Time:	15:00
 #Purpose:			starts, stops and status the exemplar binary csc_deleteNachlieferPos for presentation only
 ###############################################################################################
 ...
 readonly BINARY=csc_deleteNachlieferPos.bin
 ...
 ###############################################################################################
 . $(dirname $0)/csc_deleteNachlieferPos.option
