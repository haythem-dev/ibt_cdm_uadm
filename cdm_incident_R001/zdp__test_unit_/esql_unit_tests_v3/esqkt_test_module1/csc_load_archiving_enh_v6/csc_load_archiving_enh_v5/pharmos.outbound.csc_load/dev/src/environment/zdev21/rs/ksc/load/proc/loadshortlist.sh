#! /usr/bin/ksh
 ...
 #Creation-Time:	18:09
 #Purpose:			starts, stops and status the exemplar binary loadshortlist for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 18:09:27"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadshortlist.option
 ...
 . $(dirname $0)/../vars/loadshortlist.vars;
