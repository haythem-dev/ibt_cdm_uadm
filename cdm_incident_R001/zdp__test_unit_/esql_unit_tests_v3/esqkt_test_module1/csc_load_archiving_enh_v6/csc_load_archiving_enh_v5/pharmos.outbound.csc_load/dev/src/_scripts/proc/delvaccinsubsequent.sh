#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary delvaccinsubsequent for presentation only.   
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=delvaccinsubsequent.bin
 ...
 ###############################################################################################
 . $(dirname $0)/delvaccinsubsequent.option
 ...
 . $(dirname $0)/../vars/delvaccinsubsequent.vars;
