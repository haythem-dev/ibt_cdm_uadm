#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary unload_akdauftragposbtm for presentation only.
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=unload_akdauftragposbtm._sh
 ...
 ###############################################################################################
 . $(dirname $0)/unload_akdauftragposbtm.option
