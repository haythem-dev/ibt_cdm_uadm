#! /usr/bin/ksh
 ...
 #Creation-Time:	17:29
 #Purpose:			starts, stops and status the exemplar binary tpldartindex for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=tpldartindex.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "09.09.08 17:29:41"; fi
 ...
 . $(dirname $0)/../vars/tpldartindex.vars;
