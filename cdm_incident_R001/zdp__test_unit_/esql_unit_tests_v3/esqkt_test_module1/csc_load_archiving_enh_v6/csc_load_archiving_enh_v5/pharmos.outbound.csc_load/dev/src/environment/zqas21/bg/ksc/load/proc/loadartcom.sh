#! /usr/bin/ksh
 ...
 #Creation-Time:     16:41                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadartcom for presentation only.            
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadartcom.bin
 ...
 . $(dirname $0)/../vars/loadartcom.vars;
