#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadcharge for presentation only.            
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcharge.bin
 ...
 . $(dirname $0)/../vars/loadcharge.vars;
