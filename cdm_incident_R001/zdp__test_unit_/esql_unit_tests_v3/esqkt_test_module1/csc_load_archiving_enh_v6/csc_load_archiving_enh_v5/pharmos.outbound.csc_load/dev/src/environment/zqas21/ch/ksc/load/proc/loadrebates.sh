#! /usr/bin/ksh
 ...
 #Creation-Time:	18:01
 #Purpose:			starts, stops and status the exemplar binary loadrebates for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 18:01:33"; fi
 ...
 . $(dirname $0)/../vars/loadrebates.vars;
