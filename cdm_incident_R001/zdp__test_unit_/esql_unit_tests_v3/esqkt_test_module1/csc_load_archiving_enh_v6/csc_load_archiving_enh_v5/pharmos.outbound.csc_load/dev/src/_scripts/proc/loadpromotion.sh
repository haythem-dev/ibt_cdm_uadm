#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadpromotion for presentation only.         
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadpromotion.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadpromotion.option
 ...
 . $(dirname $0)/../vars/loadpromotion.vars;
