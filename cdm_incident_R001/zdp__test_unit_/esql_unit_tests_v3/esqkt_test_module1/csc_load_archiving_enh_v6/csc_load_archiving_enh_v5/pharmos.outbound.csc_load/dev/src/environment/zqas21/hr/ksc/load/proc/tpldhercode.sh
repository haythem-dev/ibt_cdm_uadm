#! /usr/bin/ksh
 ...
 #Creation-Time:	13:05
 #Purpose:			starts, stops and status the exemplar binary tpldhercode for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=tpldhercode.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "19.09.08 13:05:26"; fi
 ...
 . $(dirname $0)/../vars/tpldhercode.vars;
