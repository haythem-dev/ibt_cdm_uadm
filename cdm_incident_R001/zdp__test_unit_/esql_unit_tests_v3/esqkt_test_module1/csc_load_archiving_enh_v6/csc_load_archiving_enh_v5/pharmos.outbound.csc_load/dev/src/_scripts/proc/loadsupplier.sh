#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadsupplier for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadsupplier.bin
 ...
 . $(dirname $0)/../vars/loadsupplier.vars;
