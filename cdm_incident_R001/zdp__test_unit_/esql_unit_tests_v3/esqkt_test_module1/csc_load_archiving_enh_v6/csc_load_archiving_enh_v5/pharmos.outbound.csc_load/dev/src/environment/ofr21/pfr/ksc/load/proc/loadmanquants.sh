#! /usr/bin/ksh
 ...
 #Creation-Time:	17:33
 #Purpose:			starts, stops and status the exemplar binary loadmanquants for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 17:33:38"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadmanquants.option
 ...
 . $(dirname $0)/../vars/loadmanquants.vars;
