#! /usr/bin/ksh
 ...
 #Creation-Time:     16:49                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary deldupquota for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=deldupquota.bin
 ...
 . $(dirname $0)/../vars/deldupquota.vars;
