...
/******************************************************************************/
/* d:\prj\DF\UNIX\loadcharge\ArticleCharge ************************************/
/******************************************************************************/
...
/* Length-Define of ARTICLECHARGE *********************************************/
  ...
  #define L_ARTICLECHARGE_UPD_FLAG 1
...
/* Length/Count-Define of ARTICLECHARGE ***************************************/
  ...
  #define LS_ARTICLECHARGE_UPD_FLAG 1 + 1
  ...
  #define ARTICLECHARGEUPD_FLAG 6
...
/* SqlMacros-Define of ARTICLECHARGE ******************************************/
 ...
 #define ARTICLECHARGE_UPDATE(x) \
         ...
         ARTICLECHARGE.UPD_FLAG=:x->UPD_FLAG
...
/* CreateSqlStatement of ARTICLECHARGE ****************************************/
 ...
 #define ARTICLECHARGE_CREATE(x) exec sql create table x (\
         ...
         STATECHARGE char(1) default " " not null,\
         UPD_FLAG char(1) default " " not null) in ksc extent size 31372 next size 3140 lock mode row;
