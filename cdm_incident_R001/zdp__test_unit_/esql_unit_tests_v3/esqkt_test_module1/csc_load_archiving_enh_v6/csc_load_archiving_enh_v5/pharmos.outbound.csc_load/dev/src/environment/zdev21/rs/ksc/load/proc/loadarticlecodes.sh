#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadarticlecodes for presentation only.      
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadarticlecodes.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadarticlecodes.option
 ...
 . $(dirname $0)/../vars/loadarticlecodes.vars;
