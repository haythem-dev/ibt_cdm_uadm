#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadordertypes for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadordertypes.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadordertypes.option
 ...
 . $(dirname $0)/../vars/loadordertypes.vars;
