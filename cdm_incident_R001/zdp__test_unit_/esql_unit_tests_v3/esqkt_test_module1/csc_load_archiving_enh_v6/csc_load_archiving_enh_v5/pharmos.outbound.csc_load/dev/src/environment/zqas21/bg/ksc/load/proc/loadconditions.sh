#! /usr/bin/ksh
 ...
 #Creation-Time:	10:52
 #Purpose:			starts, stops and status the exemplar binary loadconditions for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadconditions.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "19.09.08 10:52:45"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadconditions.option
 ...
 . $(dirname $0)/../vars/loadconditions.vars;
