#! /usr/bin/ksh
 ...
 #Creation-Time:	15:49
 #Purpose:			starts, stops and status the exemplar binary loadroutecheck for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadroutecheck.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 15:49:11"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadroutecheck.option
 ...
 . $(dirname $0)/../vars/loadroutecheck.vars;
