...
/******************************************************************************/
/* d:\prj\DF\UNIX\tpldzentral\ArtSpecialCond **********************************/
/******************************************************************************/
...
/* Length-Define of ARTSPECIALCOND ********************************************/
  ...
  #define L_ARTSPECIALCOND_YEARLY_BONUS_PCT 5
  #define N_ARTSPECIALCOND_YEARLY_BONUS_PCT 2
  #define L_ARTSPECIALCOND_OTHER_REBATES_PCT 5
  #define N_ARTSPECIALCOND_OTHER_REBATES_PCT 2
...
/* Length/Count-Define of ARTSPECIALCOND **************************************/
  ...
  #define LS_ARTSPECIALCOND_YEARLY_BONUS_PCT 5 + 2
  #define LS_ARTSPECIALCOND_OTHER_REBATES_PCT 5 + 2
  ...
  #define ARTSPECIALCONDYEARLY_BONUS_PCT 10
  #define ARTSPECIALCONDOTHER_REBATES_PCT 11
...
/* SqlDefine of ARTSPECIALCOND ************************************************/
 ...
 #define ARTSPECIALCOND_LISTE \
         ...
         ARTSPECIALCOND.YEARLY_BONUS_PCT,\
         ARTSPECIALCOND.OTHER_REBATES_PCT
...
/* SqlMacros-Define of ARTSPECIALCOND *****************************************/
 ...
 #define ARTSPECIALCOND_UPDATE(x) \
         ...
         ARTSPECIALCOND.YEARLY_BONUS_PCT=:x->YEARLY_BONUS_PCT,\
         ARTSPECIALCOND.OTHER_REBATES_PCT=:x->OTHER_REBATES_PCT
...
/* SqlMacros390-Define of ARTSPECIALCOND **************************************/
 ...
 #define ARTSPECIALCOND_UPDATE_390 \
         ...
         YEARLY_BONUS_PCT=:YEARLY_BONUS_PCT,\
         OTHER_REBATES_PCT=:OTHER_REBATES_PCT
...
/* original Strucur of ARTSPECIALCOND *****************************************/
 ...
 typedef struct N_ARTSPECIALCOND {
         ...
         double YEARLY_BONUS_PCT;
         double OTHER_REBATES_PCT;
        } artspecialcondS;
 #else /*TRANSCLASS*/
 typedef struct N_ARTSPECIALCOND {
         long ARTICLENO;
         ...
         double OTHER_REBATES_PCT;
			...
			return(
				...
				YEARLY_BONUS_PCT == right.YEARLY_BONUS_PCT &&
				OTHER_REBATES_PCT == right.OTHER_REBATES_PCT
				);
			}
			void clear() {
#ifdef WIN32
...
/* Stringbuffer Structur of ARTSPECIALCOND ************************************/
 ...
 struct S_ARTSPECIALCOND {
         ...
         char YEARLY_BONUS_PCT[5 + 2];
         char OTHER_REBATES_PCT[5 + 2];
         };
...
/* Stringbuffer (without strend) Structur of ARTSPECIALCOND *******************/
 ...
 struct O_ARTSPECIALCOND {
         ...
         char YEARLY_BONUS_PCT[5];
         char OTHER_REBATES_PCT[5];
         };
...
/* Sizetype  Structur (buf_desc) of ARTSPECIALCOND ****************************/
 ...
 struct I_ARTSPECIALCOND {
         ...
         short YEARLY_BONUS_PCT;
         short OTHER_REBATES_PCT;
         };
...
/* Copy-Function Struct to single Data ARTSPECIALCOND *************************/
 ...
 #define ARTSPECIALCOND_S390_COPY_TO_SINGLE(_x_) \
         ...
         YEARLY_BONUS_PCT=_x_->YEARLY_BONUS_PCT;\
         OTHER_REBATES_PCT=_x_->OTHER_REBATES_PCT;\
 ...
 #define ARTSPECIALCOND_S390_COPY_TO_STRUCT(_x_) \
          ...
          _x_->YEARLY_BONUS_PCT=YEARLY_BONUS_PCT;\
          _x_->OTHER_REBATES_PCT=OTHER_REBATES_PCT;\
...
class CARTSPECIALCOND : public ppDadeVirtual
{
	...
	public:
		...
		double		GetYearly_bonus_pct() const	{ return s.YEARLY_BONUS_PCT; }
		double		GetOther_rebates_pct() const	{ return s.OTHER_REBATES_PCT; }
		...
		void 		SetYearly_bonus_pct(double t) { s.YEARLY_BONUS_PCT = t; }
		void 		SetOther_rebates_pct(double t) { s.OTHER_REBATES_PCT = t; }
...
/* CreateSqlStatement of ARTSPECIALCOND ***************************************/
 ...
 #define ARTSPECIALCOND_CREATE(x) exec sql create table x (\
         ...
         SUPPL_DISCOUNT_PCT decimal(5,2) default 0 not null,\
         YEARLY_BONUS_PCT decimal(5,2) default 0 not null,\
         OTHER_REBATES_PCT decimal(5,2) default 0 not null) in ksc extent size 156 next size 16 lock mode row;
