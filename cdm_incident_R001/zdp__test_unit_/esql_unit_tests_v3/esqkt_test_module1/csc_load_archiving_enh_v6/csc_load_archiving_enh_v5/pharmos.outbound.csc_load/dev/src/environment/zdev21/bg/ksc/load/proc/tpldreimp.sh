#! /usr/bin/ksh
 ...
 #Creation-Time:	17:22
 #Purpose:			starts, stops and status the exemplar binary tpldreimp for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "03.09.08 17:22:00"; fi
