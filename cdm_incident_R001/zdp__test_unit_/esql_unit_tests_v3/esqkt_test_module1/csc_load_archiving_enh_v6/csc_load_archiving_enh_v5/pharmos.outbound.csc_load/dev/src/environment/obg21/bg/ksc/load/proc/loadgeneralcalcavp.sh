#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadgeneralcalcavp for presentation only.    
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadgeneralcalcavp.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadgeneralcalcavp.option
 ...
 . $(dirname $0)/../vars/loadgeneralcalcavp.vars;
