#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadsupplierarticlenumber for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadsupplierarticlenumber.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadsupplierarticlenumber.option
 ...
 . $(dirname $0)/../vars/loadsupplierarticlenumber.vars;
