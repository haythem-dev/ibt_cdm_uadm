...
/* ToDo Programmname */
#define PROJECTNAME	 "loadpusupplier"
...
/* ToDo Structur */
pusupplierS indatensatz;
pusupplierS outdatensatz;
...
int LadeDaten( char *error_msg)
{
	...
	for ( ;; )
	{
		...
		/* ToDo Indexfelder */
		exec sql open CupdloadData using :indatensatz.BESLA_NR;
...
/*	vorhandene Daten	*/
	...
	strcpy(str, "update pusupplier set ");
	/* ToDo Tabelle */
	strcat(str, PUSUPPLIER_UPDLISTE);
	...
	strcpy(str, "insert into pusupplier (");
	/* ToDo Tabelle */
	strcat(str, PUSUPPLIER_PELISTE);
	strcat(str, ",upd_flag ");
	strcat(str, " ) values ( ");
