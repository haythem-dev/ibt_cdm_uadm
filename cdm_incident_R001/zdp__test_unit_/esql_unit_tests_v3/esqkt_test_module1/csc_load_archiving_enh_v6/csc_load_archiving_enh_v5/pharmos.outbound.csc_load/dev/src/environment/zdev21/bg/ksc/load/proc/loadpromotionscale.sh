#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadpromotionscale for presentation only.    
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadpromotionscale.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadpromotionscale.option
 ...
 . $(dirname $0)/../vars/loadpromotionscale.vars;
