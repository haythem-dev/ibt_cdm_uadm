...
------------------------------------------------------------------------------------------------
0.0.2.02    21.08.20	Added "and k.kdgruppe in ('01','02','03','06') " in order to include only
                        the direct users.
------------------------------------------------------------------------------------------------
*/
///////////////////////////////////////////////////////////////////////////////////////
...
#define PROG_VERSION         "0.0.2.02" // update version-history at the top
