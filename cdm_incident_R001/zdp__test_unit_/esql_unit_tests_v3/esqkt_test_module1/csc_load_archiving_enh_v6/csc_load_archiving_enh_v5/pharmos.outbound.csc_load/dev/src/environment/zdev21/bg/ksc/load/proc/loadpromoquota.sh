#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadpromoquota for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadpromoquota.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadpromoquota.option
 ...
 . $(dirname $0)/../vars/loadpromoquota.vars;
