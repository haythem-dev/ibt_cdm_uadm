#! /usr/bin/ksh
 ...
 #Creation-Time:     15:25                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loaddebtlimit for presentation only.         
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loaddebtlimit.bin
...
# 	 fi
 ...
 ###############################################################################################
 . $(dirname $0)/loaddebtlimit.option
 ...
 . $(dirname $0)/../vars/loaddebtlimit.vars;
