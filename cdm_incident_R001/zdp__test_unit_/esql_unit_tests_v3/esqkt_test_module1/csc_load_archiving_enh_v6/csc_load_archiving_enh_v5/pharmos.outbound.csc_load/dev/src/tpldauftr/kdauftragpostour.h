...
#define L_KDAUFTRAGPOSTOUR_TOURSTOPSEQUENCE 11
#define L_KDAUFTRAGPOSTOUR_CARRIER 10
...
#define LS_KDAUFTRAGPOSTOUR_TOURSTOPSEQUENCE 10 + 1
#define LS_KDAUFTRAGPOSTOUR_CARRIER 10 + 1
...
#define KDAUFTRAGPOSTOURTOURSTOPSEQUENCE 15
#define KDAUFTRAGPOSTOURCARRIER 16
...
#define KDAUFTRAGPOSTOUR_LISTE \
        ...
        KDAUFTRAGPOSTOUR.TOURSTOPSEQUENCE,\
        KDAUFTRAGPOSTOUR.CARRIER
...
#define KDAUFTRAGPOSTOUR_UPDATE(x) \
        ...
        KDAUFTRAGPOSTOUR.TOURSTOPSEQUENCE=:x->TOURSTOPSEQUENCE,\
        KDAUFTRAGPOSTOUR.CARRIER=:x->CARRIER
...
#define KDAUFTRAGPOSTOUR_UPDATE_390 \
        ...
        TOURSTOPSEQUENCE=:TOURSTOPSEQUENCE,\
        CARRIER=:CARRIER
#ifdef TRANSCLASS
#include <string.h>
#endif
...
typedef struct N_KDAUFTRAGPOSTOUR {
    ...
    bool operator == (const N_KDAUFTRAGPOSTOUR& right) const {
        return (
            ...
            TOURSTOPSEQUENCE == right.TOURSTOPSEQUENCE &&
            !strcmp(CARRIER, right.CARRIER)
        );
    }
    void clear() {
#ifdef WIN32
...
/* Copy-Function Struct to single Data KDAUFTRAGPOSTOUR ***********************/
 ...
 #define KDAUFTRAGPOSTOUR_S390_COPY_TO_SINGLE(_x_) \
         ...
         TOURSTOPSEQUENCE=_x_->TOURSTOPSEQUENCE;\
          strcpy(CARRIER,_x_->CARRIER);\
 ...
 #define KDAUFTRAGPOSTOUR_S390_COPY_TO_STRUCT(_x_) \
          ...
          _x_->TOURSTOPSEQUENCE=TOURSTOPSEQUENCE;\
          strcpy(_x_->CARRIER,CARRIER);\
...
public:
    ...
    long         GetTourstopsequence() const { return s.TOURSTOPSEQUENCE; }
    const char*  GetCarrier(ppString & t) const { t = s.CARRIER; t.erasespace(ppString::END); return t.c_str(); }
    ...
    void         SetTourstopsequence(long t) { s.TOURSTOPSEQUENCE = t; }
    void         SetCarrier(const ppString & t) { ppGStrCopy(s.CARRIER, t.c_str(), L_KDAUFTRAGPOSTOUR_CARRIER); }
...
/* CreateSqlStatement of KDAUFTRAGPOSTOUR *************************************/
 ...
 #define KDAUFTRAGPOSTOUR_CREATE(x) EXEC SQL create table x (\
         ...
         IBTTOURDATE integer default 0 not null,\
         TOURSTOPSEQUENCE integer default 0 not null,\
         CARRIER char(10) default " " not null) in dbsdata extent size 10980 next size 1100 lock mode row;
