#! /usr/bin/ksh
 ...
 #Creation-Time:	18:58
 #Purpose:			starts, stops and status the exemplar binary tpldant for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 18:58:14"; fi
