...
/******************************************************************************/
/* d:\prj\DF\UNIX\loaddebtlimit\debtlimit *************************************/
/******************************************************************************/
...
/* Length-Define of DEBTLIMIT *************************************************/
  ...
  #define L_DEBTLIMIT_SUM_LISTE5 13
  #define N_DEBTLIMIT_SUM_LISTE5 2
  #define L_DEBTLIMIT_SUM_ORDERLISTE5 13
  #define N_DEBTLIMIT_SUM_ORDERLISTE5 2
...
/* Length/Count-Define of DEBTLIMIT *******************************************/
  ...
  #define LS_DEBTLIMIT_SUM_LISTE5 13 + 2
  #define LS_DEBTLIMIT_SUM_ORDERLISTE5 13 + 2
  ...
  #define DEBTLIMITSUM_LISTE5 11
  #define DEBTLIMITSUM_ORDERLISTE5 12
...
/* SqlDefine of DEBTLIMIT *****************************************************/
 ...
 #define DEBTLIMIT_LISTE \
         ...
         DEBTLIMIT.LIMITTYPE,\
         DEBTLIMIT.LISTE5,\
         DEBTLIMIT.SUM_LISTE5,\
         DEBTLIMIT.SUM_ORDERLISTE5
...
/* SqlMacros-Define of DEBTLIMIT **********************************************/
 ...
 #define DEBTLIMIT_UPDATE(x) \
         ...
         DEBTLIMIT.SUM_LISTE5=:x->SUM_LISTE5,\
         DEBTLIMIT.SUM_ORDERLISTE5=:x->SUM_ORDERLISTE5
...
/* SqlMacros390-Define of DEBTLIMIT *******************************************/
 ...
 #define DEBTLIMIT_UPDATE_390 \
         ...
         LIMITTYPE=:LIMITTYPE,\
         LISTE5=:LISTE5,\
         SUM_LISTE5=:SUM_LISTE5,\
         SUM_ORDERLISTE5=:SUM_ORDERLISTE5
 ...
 typedef struct N_DEBTLIMIT {
         ...
         double SUM_ORDERLISTE5;
			...
			return(
				...
				SUM_LISTE5 == right.SUM_LISTE5 &&
				SUM_ORDERLISTE5 == right.SUM_ORDERLISTE5
				);
			}
			void clear() {
#ifdef WIN32
...
/* Stringbuffer Structur of DEBTLIMIT *****************************************/
 ...
 struct S_DEBTLIMIT {
         ...
         char LIMITTYPE[7];
         char LISTE5[1 + 1];
         char SUM_LISTE5[13 + 2];
         char SUM_ORDERLISTE5[13 + 2];
         };
...
/* Copy-Function Struct to single Data DEBTLIMIT ******************************/
 ...
 #define DEBTLIMIT_S390_COPY_TO_SINGLE(_x_) \
         ...
         LISTE5=_x_->LISTE5;\
         SUM_LISTE5=_x_->SUM_LISTE5;\
         SUM_ORDERLISTE5=_x_->SUM_ORDERLISTE5;\
 ...
 #define DEBTLIMIT_S390_COPY_TO_STRUCT(_x_) \
          ...
          _x_->LISTE5=LISTE5;\
          _x_->SUM_LISTE5=SUM_LISTE5;\
          _x_->SUM_ORDERLISTE5=SUM_ORDERLISTE5;\
...
class CDEBTLIMIT : public ppDadeVirtual
{
	...
	public:
		...
		double		GetSum_liste5() const	{ return s.SUM_LISTE5; }
		double		GetSum_orderliste5() const	{ return s.SUM_ORDERLISTE5; }
		...
		void 		SetSum_liste5(double t) { s.SUM_LISTE5 = t; }
		void 		SetSum_orderliste5(double t) { s.SUM_ORDERLISTE5 = t; }
...
/* CreateSqlStatement of DEBTLIMIT ********************************************/
 ...
 #define DEBTLIMIT_CREATE(x) exec sql create table x (\
         ...
         LISTE5 char(1) default " " not null,\
         SUM_LISTE5 decimal(13,2) default 0 not null,\
         SUM_ORDERLISTE5 decimal(13,2) default 0 not null) in ksc extent size 8 next size 8 lock mode row;
