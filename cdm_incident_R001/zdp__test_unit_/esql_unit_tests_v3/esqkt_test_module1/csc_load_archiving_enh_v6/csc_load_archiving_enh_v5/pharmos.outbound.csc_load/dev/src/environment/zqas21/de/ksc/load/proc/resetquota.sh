#! /usr/bin/ksh
 ...
 #Creation-Time:	16:10
 #Purpose:			starts, stops and status the exemplar binary resetquota for presentation only
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=resetquota.bin
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "05.09.08 16:10:25"; fi
 ...
 . $(dirname $0)/../vars/resetquota.vars;
