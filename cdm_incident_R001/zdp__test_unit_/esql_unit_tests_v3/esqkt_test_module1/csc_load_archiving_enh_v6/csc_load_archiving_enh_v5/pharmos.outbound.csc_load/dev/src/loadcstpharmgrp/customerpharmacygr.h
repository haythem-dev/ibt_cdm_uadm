#ifndef __PP_CUSTOMERPHARMACYGR_H_
#define __PP_CUSTOMERPHARMACYGR_H_

/******************************************************************************/
/* d:\prj\DF\UNIX\loadcstpharmgrp\CustomerPharmacyGr **************************/
/******************************************************************************/
...
/* Length-Define of CUSTOMERPHARMACYGR ****************************************/
  ...
  #define L_CUSTOMERPHARMACYGR_UPD_FLAG 1
...
/* Length/Count-Define of CUSTOMERPHARMACYGR **********************************/
  ...
  #define LS_CUSTOMERPHARMACYGR_UPD_FLAG 1 + 1
  ...
  #define CUSTOMERPHARMACYGRUPD_FLAG 4
...
/* SqlMacros-Define of CUSTOMERPHARMACYGR *************************************/
 ...
 #define CUSTOMERPHARMACYGR_UPDATE(x) \
         ...
         CUSTOMERPHARMACYGR.UPD_FLAG=:x->UPD_FLAG
...
/* Structur with real chartype of CUSTOMERPHARMACYGR **************************/
...
/* Sizetype  Structur (buf_desc) of CUSTOMERPHARMACYGR ************************/
...
/* CreateSqlStatement of CUSTOMERPHARMACYGR ***********************************/
 ...
 #define CUSTOMERPHARMACYGR_CREATE(x) exec sql create table x (\
         ...
         RANKING smallint default 0 not null,\
