#! /usr/bin/ksh
 ...
 #Creation-Time:	11:31
 #Purpose:			starts, stops and status the exemplar binary loadcstshort for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "11.11.08 11:31:33"; fi
 ...
 . $(dirname $0)/../vars/loadcstshort.vars;
