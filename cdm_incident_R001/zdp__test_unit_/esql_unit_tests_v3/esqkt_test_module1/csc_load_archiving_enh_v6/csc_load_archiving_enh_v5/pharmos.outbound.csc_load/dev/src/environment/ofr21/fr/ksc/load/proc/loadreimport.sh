#! /usr/bin/ksh
 ...
 #Creation-Time:	18:08
 #Purpose:			starts, stops and status the exemplar binary loadreimport for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 18:08:07"; fi
 ...
 . $(dirname $0)/../vars/loadreimport.vars;
