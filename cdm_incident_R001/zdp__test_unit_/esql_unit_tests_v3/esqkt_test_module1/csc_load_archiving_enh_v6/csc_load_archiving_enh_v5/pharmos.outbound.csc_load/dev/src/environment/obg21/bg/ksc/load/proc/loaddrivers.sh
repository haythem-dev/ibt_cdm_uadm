#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loaddrivers for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loaddrivers.bin
 ...
 . $(dirname $0)/../vars/loaddrivers.vars;
