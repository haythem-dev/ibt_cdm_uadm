...
/* ToDo Programmname */
#define PROJECTNAME	 "loadtradegroup"
...
/* ToDo Structur */
tradegroupS indatensatz;
tradegroupS outdatensatz;
...
int LadeDaten( char *error_msg)
{
	...
	for ( ;; )
	{
		...
		/* ToDo Indexfelder */
		exec sql open CupdloadData using :indatensatz.ARTIKEL_NR,:indatensatz.ART;
...
/*	vorhandene Daten	*/
	...
	strcpy(str, "update tradegroup set ");
	/* ToDo Tabelle */
	strcat(str, TRADEGROUP_UPDLISTE);
	...
	strcpy(str, "insert into tradegroup (");
	/* ToDo Tabelle */
	strcat(str, TRADEGROUP_PELISTE);
	strcat(str, ",upd_flag ");
	strcat(str, " ) values ");
