#! /usr/bin/ksh
 ...
 #Creation-Time:	17:55
 #Purpose:			starts, stops and status the exemplar binary loadpricehistory for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 17:55:31"; fi
 ...
 ###############################################################################################
 . $(dirname $0)/loadpricehistory.option
 ...
 . $(dirname $0)/../vars/loadpricehistory.vars;
