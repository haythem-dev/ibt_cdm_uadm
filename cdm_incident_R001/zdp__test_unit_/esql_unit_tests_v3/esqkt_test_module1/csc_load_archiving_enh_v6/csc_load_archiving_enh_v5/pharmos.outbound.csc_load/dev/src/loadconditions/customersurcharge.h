...
/******************************************************************************/
/* d:\prj\DF\UNIX\loadconditions\CustomerSurcharge ****************************/
/******************************************************************************/
...
/* Length-Define of CUSTOMERSURCHARGE *****************************************/
  ...
  #define L_CUSTOMERSURCHARGE_UPDATESIGN 1
...
/* Length/Count-Define of CUSTOMERSURCHARGE ***********************************/
  ...
  #define LS_CUSTOMERSURCHARGE_UPDATESIGN 1 + 1
  ...
  #define CUSTOMERSURCHARGEUPDATESIGN 4
...
/* SqlMacros-Define of CUSTOMERSURCHARGE **************************************/
 ...
 #define CUSTOMERSURCHARGE_UPDATE(x) \
         ...
         CUSTOMERSURCHARGE.UPDATESIGN=:x->UPDATESIGN
...
/* CreateSqlStatement of CUSTOMERSURCHARGE ************************************/
 ...
 #define CUSTOMERSURCHARGE_CREATE(x) exec sql create table x (\
         ...
         UPDATESIGN char(1) default " " not null) in ksc extent size 8 next size 8 lock mode row;
