#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadmanufacturergroup for presentation only. 
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadmanufacturergroup.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadmanufacturergroup.option
 ...
 . $(dirname $0)/../vars/loadmanufacturergroup.vars;
