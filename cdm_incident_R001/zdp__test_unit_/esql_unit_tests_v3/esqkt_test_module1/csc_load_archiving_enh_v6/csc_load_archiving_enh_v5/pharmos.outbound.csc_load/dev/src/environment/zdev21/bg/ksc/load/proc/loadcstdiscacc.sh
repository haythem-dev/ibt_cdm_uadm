#! /usr/bin/ksh
 ...
 #Creation-Time:     14:40                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadcstdiscacc for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcstdiscacc.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadcstdiscacc.option
 ...
 . $(dirname $0)/../vars/loadcstdiscacc.vars;
