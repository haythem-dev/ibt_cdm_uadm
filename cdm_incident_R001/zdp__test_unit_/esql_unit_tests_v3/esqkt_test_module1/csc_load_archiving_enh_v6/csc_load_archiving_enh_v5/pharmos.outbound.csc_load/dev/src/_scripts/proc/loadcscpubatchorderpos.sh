#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadcscpubatchorderpos for presentation only.        
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcscpubatchorderpos.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadcscpubatchorderpos.option
 ...
 . $(dirname $0)/../vars/loadcscpubatchorderpos.vars;
