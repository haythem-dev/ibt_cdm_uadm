#! /usr/bin/ksh
 ...
 #Creation-Time:	17:25
 #Purpose:			starts, stops and status the exemplar binary tpldoldprice for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "12.11.08 17:25:55"; fi
 ...
 . $(dirname $0)/../vars/tpldoldprice.vars;
