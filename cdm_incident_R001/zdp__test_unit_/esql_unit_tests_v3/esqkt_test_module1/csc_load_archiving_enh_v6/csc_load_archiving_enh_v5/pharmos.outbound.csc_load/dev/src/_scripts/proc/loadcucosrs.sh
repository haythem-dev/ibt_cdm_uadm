#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadcucosrs for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadcucosrs.bin
 ...
 . $(dirname $0)/../vars/loadcucosrs.vars;
