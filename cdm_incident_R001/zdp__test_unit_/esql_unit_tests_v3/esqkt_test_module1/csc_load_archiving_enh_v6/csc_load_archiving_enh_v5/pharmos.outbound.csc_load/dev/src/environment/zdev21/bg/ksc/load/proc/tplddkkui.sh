#! /usr/bin/ksh
 ...
 #Creation-Time:	12:53
 #Purpose:			starts, stops and status the exemplar binary tplddkkui for presentation only
 ###############################################################################################
 ...
 {
 	 if [[ "$2" == "" ]]; then set $1 "10.09.08 12:53:12"; fi
