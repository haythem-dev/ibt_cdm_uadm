#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadarticlecodeseanzdp for presentation only.
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadarticlecodeseanzdp.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadarticlecodeseanzdp.option
 ...
 . $(dirname $0)/../vars/loadarticlecodeseanzdp.vars;
