#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadservices for presentation only.          
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadservices.bin
 ...
 . $(dirname $0)/../vars/loadservices.vars;
