#! /usr/bin/ksh
 ...
 #Creation-Time:     16:41                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadarticleinfo for presentation only.       
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadarticleinfo.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadarticleinfo.option
 ...
 . $(dirname $0)/../vars/loadarticleinfo.vars;
