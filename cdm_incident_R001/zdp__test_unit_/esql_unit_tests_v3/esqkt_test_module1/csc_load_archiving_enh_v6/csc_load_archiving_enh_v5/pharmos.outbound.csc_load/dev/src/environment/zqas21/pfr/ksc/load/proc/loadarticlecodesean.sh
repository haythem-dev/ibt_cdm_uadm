#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary loadarticlecodesean for presentation only.   
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadarticlecodesean.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadarticlecodesean.option
 ...
 . $(dirname $0)/../vars/loadarticlecodesean.vars;
