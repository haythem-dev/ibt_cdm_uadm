#! /usr/bin/ksh
 ...
 #Creation-Time:     16:21                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadrouting for presentation only.           
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadrouting.bin
 ...
 function print_local_var
 {
	 ...
	 printf "%-30s%-90s\n" "\$VON_OPTION:" ">$VON_OPTION<"
	 printf "%-30s%-90s\n" "\$BIS_OPTION:" ">$BIS_OPTION<"
	 printf "%-30s%-90s\n" "\$LD_OPTION:" ">$LD_OPTION<"
 ...
 . $(dirname $0)/../vars/loadrouting.vars;
