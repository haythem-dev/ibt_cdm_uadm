#! /usr/bin/ksh
 ...
 #Creation-Time:     16:26                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary setarticlecategory for presentation only.    
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=setarticlecategory.bin
 ...
 ###############################################################################################
 . $(dirname $0)/setarticlecategory.option
 ...
 . $(dirname $0)/../vars/setarticlecategory.vars;
