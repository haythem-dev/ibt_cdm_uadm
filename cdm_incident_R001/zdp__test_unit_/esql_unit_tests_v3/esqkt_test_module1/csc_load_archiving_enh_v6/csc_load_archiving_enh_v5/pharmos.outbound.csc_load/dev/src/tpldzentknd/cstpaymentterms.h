...
/******************************************************************************/
/* d:\prj\DF\UNIX\TPLDZENTKND\CstPaymentTerms *********************************/
/******************************************************************************/
...
/* Length-Define of CSTPAYMENTTERMS *******************************************/
  ...
  #define L_CSTPAYMENTTERMS_UPD_FLAG 1
...
/* Length/Count-Define of CSTPAYMENTTERMS *************************************/
  ...
  #define LS_CSTPAYMENTTERMS_UPD_FLAG 1 + 1
  ...
  #define CSTPAYMENTTERMSUPD_FLAG 4
...
/* SqlMacros-Define of CSTPAYMENTTERMS ****************************************/
 ...
 #define CSTPAYMENTTERMS_UPDATE(x) \
         ...
         CSTPAYMENTTERMS.UPD_FLAG=:x->UPD_FLAG
