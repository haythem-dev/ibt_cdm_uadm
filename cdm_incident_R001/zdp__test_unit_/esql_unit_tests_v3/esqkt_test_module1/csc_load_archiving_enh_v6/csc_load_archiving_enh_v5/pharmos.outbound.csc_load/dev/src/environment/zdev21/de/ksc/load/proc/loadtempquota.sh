#! /usr/bin/ksh
 ...
 #Creation-Time:     14:02                                                                                     
 #Purpose:           Starts, stops and status the exemplar binary loadtempquota for presentation only.         
 ###############################################################################################
 ...
 #--------------------------------------------------------------------#
 readonly BINARY=loadtempquota.bin
 ...
 ###############################################################################################
 . $(dirname $0)/loadtempquota.option
 ...
 . $(dirname $0)/../vars/loadtempquota.vars;
