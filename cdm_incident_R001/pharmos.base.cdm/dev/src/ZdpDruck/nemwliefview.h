#if !defined(AFX_NEMWLIEFVIEW_H__5A2FB4B8_7842_40F6_9B37_40F5C8E2D0B9__INCLUDED_)
#define AFX_NEMWLIEFVIEW_H__5A2FB4B8_7842_40F6_9B37_40F5C8E2D0B9__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// NemwliefView.h : Header-Datei
//

/////////////////////////////////////////////////////////////////////////////
// Formularansicht CNemwliefView 
...
class CNemwliefView : public ChPflegeView
{
public:
	CNemwliefView();   

	DECLARE_DYNCREATE(CNemwliefView)

// Formulardaten
public:
	//{{AFX_DATA(CNemwliefView)
	enum { IDD = IDD_NEMWLIEF };
...
private:
	...
	bool  IsViaStdout();
	int   ReadViaStdout();
	void  BufFromZeile( struct BUFF_NEMLIEF *p, CString Zeile );
...
#endif // AFX_NEMWLIEFVIEW_H__5A2FB4B8_7842_40F6_9B37_40F5C8E2D0B9__INCLUDED_
