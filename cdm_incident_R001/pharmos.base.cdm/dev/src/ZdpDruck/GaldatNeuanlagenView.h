...
// CGaldatNeuanlagenView-Formularansicht

class CGaldatNeuanlagenView : public ChPflegeView
{
	DECLARE_DYNCREATE(CGaldatNeuanlagenView)

protected:
	
	virtual ~CGaldatNeuanlagenView();
public:
...
private:
	...
	void  BufFromZeile( struct BUFF_LOGINDEX *p, CString Zeile );
