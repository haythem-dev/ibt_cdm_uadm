#if !defined(AFX_ARTSPERRVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_)
#define AFX_ARTSPERRVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Art7prozView.h : Header-Datei
//

/////////////////////////////////////////////////////////////////////////////
// Formularansicht CArtsperrView 
...
class CArtsperrView : public ChPflegeView
{
public:
	CArtsperrView();  

	DECLARE_DYNCREATE(CArtsperrView)

// Formulardaten
public:
	//{{AFX_DATA(CArtsperrView)
	enum { IDD = IDD_ARTSPERR };
...
#endif // AFX_ARTSPERRVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_
