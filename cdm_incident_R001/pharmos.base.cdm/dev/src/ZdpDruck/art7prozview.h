#if !defined(AFX_ART7PROZVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_)
#define AFX_ART7PROZVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_
...
class CArt7prozView : public ChPflegeView
{
public:
	CArt7prozView();  

	DECLARE_DYNCREATE(CArt7prozView)

// Formulardaten
public:
	//{{AFX_DATA(CArt7prozView)
	enum { IDD = IDD_ART7PROZ };
...
#endif // AFX_ART7PROZVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_
