#if !defined(AFX_NONEMLIEVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_)
#define AFX_NONEMLIEVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_
...
class CNonemlieView : public ChPflegeView
{
public:
	CNonemlieView();  

	DECLARE_DYNCREATE(CNonemlieView)

// Formulardaten
public:
	//{{AFX_DATA(CNonemlieView)
	enum { IDD = IDD_NONEMLIE };
...
#endif // AFX_NONEMLIEVIEW_H__FB4FB5F6_BB2D_4BF9_BAAE_E94582F0A9C5__INCLUDED_
