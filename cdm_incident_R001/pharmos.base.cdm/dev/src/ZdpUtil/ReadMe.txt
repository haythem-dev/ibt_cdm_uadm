========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ZdpUtil
========================================================================


Diese ZdpUtil-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ZdpUtil.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ZdpUtil.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ZdpUtil.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ZdpUtilDoc.h, ZdpUtilDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CZdpUtilDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CZdpUtilDoc::Serialize).

ZdpUtilView.h, ZdpUtilView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CZdpUtilView.
    	CZdpUtilView-Objekte werden verwendet, um CZdpUtilDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ZdpUtil.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
