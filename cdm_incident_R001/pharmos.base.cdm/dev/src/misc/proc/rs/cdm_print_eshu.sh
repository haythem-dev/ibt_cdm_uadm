 ...
 #Creation-Time:	09:58
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_hr for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_rs.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_rs;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/hr/cdm 16.07.08 09:58:49; fi
