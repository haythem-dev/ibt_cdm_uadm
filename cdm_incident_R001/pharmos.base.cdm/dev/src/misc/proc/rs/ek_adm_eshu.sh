 ...
 #Creation-Time:	14:48
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_rs for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_rs.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_rs;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/rs/cdm 15.07.08 14:48:05; fi
