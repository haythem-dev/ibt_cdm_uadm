 ...
 #Creation-Time:	10:10
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_hr for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_rs.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_rs;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/rs/cdm 16.07.08 10:10:03; fi
