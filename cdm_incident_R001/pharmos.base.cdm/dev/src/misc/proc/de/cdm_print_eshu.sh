 ...
 #Creation-Time:	09:53
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_de for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_de.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_de;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/de/cdm 16.07.08 09:53:27; fi
