 ...
 #Creation-Time:	10:08
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_de for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_de.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_de;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/de/cdm 16.07.08 10:08:11; fi
