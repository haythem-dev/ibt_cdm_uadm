 ...
 #Creation-Time:	11:27
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_de for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_de.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_de;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/de/cdm 15.07.08 11:27:35; fi
