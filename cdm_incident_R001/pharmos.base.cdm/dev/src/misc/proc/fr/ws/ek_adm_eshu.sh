 ...
 #Creation-Time:	14:49
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_fr_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_fr_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_fr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/ws 15.07.08 14:49:01; fi
