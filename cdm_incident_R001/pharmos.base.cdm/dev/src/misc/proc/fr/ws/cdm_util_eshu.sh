 ...
 #Creation-Time:	10:12
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_fr_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_fr_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_fr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/ws 16.07.08 10:12:34; fi
