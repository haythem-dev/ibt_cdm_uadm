 ...
 #Creation-Time:	09:59
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_fr_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_fr_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_fr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/ws 16.07.08 09:59:32; fi
