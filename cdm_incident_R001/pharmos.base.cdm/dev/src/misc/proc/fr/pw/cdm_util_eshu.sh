 ...
 #Creation-Time:	10:13
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_fr_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_fr_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_pfr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/pw 16.07.08 10:13:15; fi
 ...
 ###############################################################################################
 . $(dirname $0)/cdm_util_eshu.option
