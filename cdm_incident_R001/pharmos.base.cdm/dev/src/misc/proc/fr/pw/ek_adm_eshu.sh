 ...
 #Creation-Time:	14:51
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_fr_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_fr_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_pfr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/pw 15.07.08 14:51:05; fi
