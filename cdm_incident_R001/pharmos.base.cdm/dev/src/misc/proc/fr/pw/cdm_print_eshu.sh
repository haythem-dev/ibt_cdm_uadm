 ...
 #Creation-Time:	10:00
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_fr_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_fr_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_pfr;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/fr/cdm/pw 16.07.08 10:00:28; fi
