 ...
 #Creation-Time:	10:09
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_at for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_at_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_pat;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/at/cdm 16.07.08 10:09:27; fi
