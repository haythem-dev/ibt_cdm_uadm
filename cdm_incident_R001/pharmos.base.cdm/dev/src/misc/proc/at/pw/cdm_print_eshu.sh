 ...
 #Creation-Time:	09:54
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_at for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_at_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_pat;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/at/cdm 16.07.08 09:54:34; fi
