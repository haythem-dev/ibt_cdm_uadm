 ...
 #Creation-Time:	14:46
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_at for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_at_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_pat;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/at/cdm 15.07.08 14:46:24; fi
