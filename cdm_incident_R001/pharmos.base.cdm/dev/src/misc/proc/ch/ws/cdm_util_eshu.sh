 ...
 #Creation-Time:	10:10
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_ch_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_ch_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_ch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/ws 16.07.08 10:10:57; fi
