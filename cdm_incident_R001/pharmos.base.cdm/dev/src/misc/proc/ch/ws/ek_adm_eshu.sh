 ...
 #Creation-Time:	14:40
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_ch_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_ch_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_ch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/ws 15.07.08 14:40:20; fi
