 ...
 #Creation-Time:	09:56
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_ch_ws for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_ch_ws.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_ch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/ws 16.07.08 09:56:35; fi
