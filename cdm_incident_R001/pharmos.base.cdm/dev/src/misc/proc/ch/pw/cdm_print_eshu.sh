 ...
 #Creation-Time:	09:57
 #Purpose:			starts, stops and status the exemplar binary zdpdruckuiserv_ch_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpdruckuiserv_ch_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_print_pch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/pw 16.07.08 09:57:45; fi
 ...
 ###############################################################################################
 . $(dirname $0)/cdm_print_eshu.option
