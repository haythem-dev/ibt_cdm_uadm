 ...
 #Creation-Time:	10:11
 #Purpose:			starts, stops and status the exemplar binary zdputiluiserv_ch_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdputiluiserv_ch_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_util_pch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/pw 16.07.08 10:11:43; fi
