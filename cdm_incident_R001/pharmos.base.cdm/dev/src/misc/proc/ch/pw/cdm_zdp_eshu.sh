 ...
 #Creation-Time:	15:11
 #Purpose:			starts, stops and status the exemplar binary zdpuiserv_ch_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=zdpuiserv_ch_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:cdm_zdp_pch;
 start="";
 stop="";
 status="";
