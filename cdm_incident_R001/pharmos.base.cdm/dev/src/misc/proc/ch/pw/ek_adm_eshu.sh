 ...
 #Creation-Time:	14:41
 #Purpose:			starts, stops and status the exemplar binary ekadmuiserv_ch_pw for presentation only
 ###############################################################################################
 ...
 readonly FORK_BINARY=ekadmuiserv_ch_pw.bin


 #--------------------------------------------------------------------#
 # INDIVIDUAL VARIABLES
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:ek_adm_pch;
 start="";
 stop="";
 status="";
 ...
 {
 	 if [[ "$2" == "" ]]; then set /software/wss/ch/cdm/pw 15.07.08 14:41:52; fi
