 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for EXPORTARTICLECALCULATOR
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "exportarticlecalculatorapplctrl.h"
#include "componentmanager/exportarticlecalculatorinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<exportarticlecalculator::ApplCtrlImpl>::InstancePtr& Singleton<exportarticlecalculator::ApplCtrlImpl>::inst()
        {
