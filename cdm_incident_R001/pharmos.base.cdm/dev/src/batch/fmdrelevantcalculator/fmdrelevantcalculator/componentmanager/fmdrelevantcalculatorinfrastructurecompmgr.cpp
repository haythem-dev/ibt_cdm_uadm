...
// include section
//----------------------------------------------------------------------------//
#include "fmdrelevantcalculatorinfrastructurecompmgr.h"
#include "fmdrelevantcalculatorinfrastructurecompmgrptr.h"
...
namespace fmdrelevantcalculator
{
    namespace componentManager
    {
        ...
        : libutil::componentManager::InfrastructureCompMgrBase  <   fmdrelevantcalculator::componentManager::ApplCompMgr,
																...
																>   ( argc, argv, fmdrelevantcalculator::LoggerPool::getLoggerFmdRelevantcalculator() )
        {
		 ...
		 void InfrastructureCompMgr::doInjectApplComponentManagerComponents() const
        {
            ...
            getApplComponentManager()->setCmdLineArguments( fmdrelevantcalculatorCmdLine->getAppArgs() );
...
//            libutil::infrastructure::i18n::LanguageFileLoaderPtr loader = libutil::infrastructure::i18n::LanguageFileLoaderPtr( new libutil::infrastructure::i18n::NullLanguageFileLoader(getLanguageCode(), getLanguageDirs()) );
       ...
       basar::I18nString InfrastructureCompMgr::getLanguageCode() const
		...
		{
			infrastructure::mail::MailAlertPtr p = infrastructure::mail::MailAlertPtr(new infrastructure::mail::MailAlert(LoggerPool::getLoggerFmdRelevantcalculator()));
