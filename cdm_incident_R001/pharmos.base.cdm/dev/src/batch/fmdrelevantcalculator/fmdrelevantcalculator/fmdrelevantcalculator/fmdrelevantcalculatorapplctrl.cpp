 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for FMDRELEVANTCALCULATOR
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "fmdrelevantcalculatorapplctrl.h"
#include "componentmanager/fmdrelevantcalculatorinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<fmdrelevantcalculator::ApplCtrlImpl>::InstancePtr& Singleton<fmdrelevantcalculator::ApplCtrlImpl>::inst()
        {
