#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary zpagpgnart_clean for presentation only.      
 ###############################################################################################
 ...
 ###############################################################################################
 . $(dirname $0)/zpagpgnart_clean.option
 ...
 . $(dirname $0)/../vars/zpagpgnart_clean.vars;
