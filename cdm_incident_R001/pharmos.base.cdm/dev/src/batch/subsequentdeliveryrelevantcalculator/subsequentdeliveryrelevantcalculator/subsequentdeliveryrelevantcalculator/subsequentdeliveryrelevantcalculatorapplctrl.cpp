 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for SUBSEQUENTDELIVERYRELEVANTCALCULATOR
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "subsequentdeliveryrelevantcalculatorapplctrl.h"
#include "componentmanager/subsequentdeliveryrelevantcalculatorinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<subsequentdeliveryrelevantcalculator::ApplCtrlImpl>::InstancePtr& 
		                       Singleton<subsequentdeliveryrelevantcalculator::ApplCtrlImpl>::inst()
        {
...
namespace subsequentdeliveryrelevantcalculator
{
    ...
    void ApplCtrlImpl::init( int argc, char* argv[])
    {
		...
		catch (libutil::exceptions::CmdLineException& e)
		{
			...
			libutil::exceptions::ExceptionHandler::processReasonException(e, getLogger(), fun, __FILE__, __LINE__);
			throw;
		}
