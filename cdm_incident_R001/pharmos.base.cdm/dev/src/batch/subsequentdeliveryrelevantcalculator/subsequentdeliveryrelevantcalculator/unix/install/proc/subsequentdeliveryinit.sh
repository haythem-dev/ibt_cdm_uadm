...
set -x
 ...
 readonly BINARY=subsequentdeliveryrelevantcalculator.bin
 process="initialize subsequentdeliverybrancharticleconfig from KSC artikellokal"
...
set -x
 ...
 dbaccess $CDM_DB << end
   delete from csubsequentdeliverybrancharticleconfig
     where branchno = $branchno;
   insert into csubsequentdeliverybrancharticleconfig
   select filialnr, artikel_nr, wafotyp, current year to second, 'dbaccess'
     from $CSC_DB:artikellokal
