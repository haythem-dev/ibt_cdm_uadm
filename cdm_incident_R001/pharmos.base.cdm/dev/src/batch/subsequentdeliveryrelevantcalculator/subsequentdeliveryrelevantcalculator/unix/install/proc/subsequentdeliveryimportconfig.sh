...
set -x
 ...
 process="dbaccess (export config)"
...
set -x
 ...
 dbaccess $CDM_DB << end
   delete from csubsequentdeliveryrule;
   load from ../data/csubsequentdeliveryrule.csv
     delimiter ';'
     insert into csubsequentdeliveryrule;

   delete from csubsequentdeliveryparam;
   load from ../data/csubsequentdeliveryparam.csv
     delimiter ';'
     insert into csubsequentdeliveryparam;
end
 exit ${rc};
