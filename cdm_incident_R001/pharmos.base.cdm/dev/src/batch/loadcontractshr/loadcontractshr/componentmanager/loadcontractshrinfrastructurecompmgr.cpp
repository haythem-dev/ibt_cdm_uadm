...
// include section
//----------------------------------------------------------------------------//
#include "loadcontractshrinfrastructurecompmgr.h"
#include "loadcontractshrinfrastructurecompmgrptr.h"
...
namespace loadcontractshr
{
    namespace componentManager
    {
        ...
        : libutil::componentManager::InfrastructureCompMgrBase  <   loadcontractshr::componentManager::ApplCompMgr,
																...
																>   ( argc, argv, loadcontractshr::LoggerPool::getLoggerLoadContractsHr() )
        {
		 ...
		 void InfrastructureCompMgr::doInjectApplComponentManagerComponents() const
        {
            ...
            getApplComponentManager()->setCmdLineArguments( LoadContractsHrCmdLine->getAppArgs() );
...
//            libutil::infrastructure::i18n::LanguageFileLoaderPtr loader = libutil::infrastructure::i18n::LanguageFileLoaderPtr( new libutil::infrastructure::i18n::NullLanguageFileLoader(getLanguageCode(), getLanguageDirs()) );
       ...
       basar::I18nString InfrastructureCompMgr::getLanguageCode() const
		...
		{
			infrastructure::mail::MailAlertPtr p = infrastructure::mail::MailAlertPtr(new infrastructure::mail::MailAlert(LoggerPool::getLoggerLoadContractsHr()));
