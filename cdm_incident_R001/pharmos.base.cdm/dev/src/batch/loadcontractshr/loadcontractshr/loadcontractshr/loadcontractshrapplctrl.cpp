 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for LOADCONTRACTSHR
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "loadcontractshrapplctrl.h"
#include "componentmanager/loadcontractshrinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<loadcontractshr::ApplCtrlImpl>::InstancePtr& Singleton<loadcontractshr::ApplCtrlImpl>::inst()
        {
