...
// include section
//----------------------------------------------------------------------------//
#include "importpricelistinfrastructurecompmgr.h"
#include "importpricelistinfrastructurecompmgrptr.h"
...
namespace importpricelist
{
    namespace componentManager
    {
        ...
        : libutil::componentManager::InfrastructureCompMgrBase  <   importpricelist::componentManager::ApplCompMgr,
																...
																>   ( argc, argv, importpricelist::LoggerPool::getLoggerImportpricelist() )
        {
		 ...
		 void InfrastructureCompMgr::doInjectApplComponentManagerComponents() const
        {
            ...
            getApplComponentManager()->setCmdLineArguments( importpricelistCmdLine->getAppArgs() );
        }
