...
#define LOG_FILE   "zputil.log"           /* Name der Logdatei */

/* Is the following flag really for turning logging on/off ?
   It should be removed as there is no use of it in this module - amar */
int IsLog = 1;
