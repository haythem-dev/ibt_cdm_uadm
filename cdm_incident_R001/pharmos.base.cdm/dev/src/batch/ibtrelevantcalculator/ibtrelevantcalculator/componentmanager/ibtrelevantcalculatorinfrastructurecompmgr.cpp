...
// include section
//----------------------------------------------------------------------------//
#include "ibtrelevantcalculatorinfrastructurecompmgr.h"
#include "ibtrelevantcalculatorinfrastructurecompmgrptr.h"
...
namespace ibtrelevantcalculator
{
    namespace componentManager
    {
        ...
        : libutil::componentManager::InfrastructureCompMgrBase  <   ibtrelevantcalculator::componentManager::ApplCompMgr,
																...
																>   ( argc, argv, ibtrelevantcalculator::LoggerPool::getLoggerIbtrelevantcalculator() )
        {
		 ...
		 void InfrastructureCompMgr::doInjectApplComponentManagerComponents() const
        {
            ...
            getApplComponentManager()->setCmdLineArguments( ibtrelevantcalculatorCmdLine->getAppArgs() );
...
//            libutil::infrastructure::i18n::LanguageFileLoaderPtr loader = libutil::infrastructure::i18n::LanguageFileLoaderPtr( new libutil::infrastructure::i18n::NullLanguageFileLoader(getLanguageCode(), getLanguageDirs()) );
       ...
       basar::I18nString InfrastructureCompMgr::getLanguageCode() const
		...
		{
			infrastructure::mail::MailAlertPtr p = infrastructure::mail::MailAlertPtr(new infrastructure::mail::MailAlert(LoggerPool::getLoggerIbtrelevantcalculator()));
