 //-------------------------------------------------------------------------------------------------//
/*! \file
*   \brief  application (main) functions for IBTRELEVANTCALCULATOR
*   \author
*   \date
*/
//-------------------------------------------------------------------------------------------------//
...
// includes
//-------------------------------------------------------------------------------------------------//
#include "ibtrelevantcalculatorapplctrl.h"
#include "componentmanager/ibtrelevantcalculatorinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<ibtrelevantcalculator::ApplCtrlImpl>::InstancePtr& Singleton<ibtrelevantcalculator::ApplCtrlImpl>::inst()
        {
