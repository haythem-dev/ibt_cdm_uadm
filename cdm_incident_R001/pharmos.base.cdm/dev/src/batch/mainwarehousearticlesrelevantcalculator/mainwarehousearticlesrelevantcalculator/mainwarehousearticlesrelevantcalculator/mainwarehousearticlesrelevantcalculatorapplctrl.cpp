...
// includes
//-------------------------------------------------------------------------------------------------//
#include "mainwarehousearticlesrelevantcalculatorapplctrl.h"
#include "componentmanager/mainwarehousearticlesrelevantcalculatorinfrastructurecompmgr.h"
...
namespace basar
{
    namespace cmnutil
    {
        /*! specialised method */
        template <>
        typename Singleton<mainwarehousearticlesrelevantcalculator::ApplCtrlImpl>::InstancePtr& Singleton<mainwarehousearticlesrelevantcalculator::ApplCtrlImpl>::inst()
        {
...
namespace mainwarehousearticlesrelevantcalculator
{
    ...
    {
        static const libutil::misc::ClassInfo info( "ApplCtrlImpl", libutil::misc::Version( 1, 0, 0, 1 ) );
        return info;
    }
