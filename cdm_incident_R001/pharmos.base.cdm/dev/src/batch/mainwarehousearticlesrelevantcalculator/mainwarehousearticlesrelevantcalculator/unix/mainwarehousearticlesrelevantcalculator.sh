#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary mainwarehousearticlesrelevantcalculator for presentation only.
 ###############################################################################################
 ...
 readonly BINARY=mainwarehousearticlesrelevantcalculator.bin
 ...
 ###############################################################################################
 . $(dirname $0)/mainwarehousearticlesrelevantcalculator.option
 ...
 export MWHARTICLES_RELCALC_BRANCHNO=$branchno
 assembling_process;
 print_msg "$STARTMSG" "$*"
