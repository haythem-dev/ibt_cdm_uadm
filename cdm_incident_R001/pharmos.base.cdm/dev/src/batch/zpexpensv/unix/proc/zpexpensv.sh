...
#Purpose:           Starts, stops and status the binary zpexpensv for presentation only.            
###############################################################################################
