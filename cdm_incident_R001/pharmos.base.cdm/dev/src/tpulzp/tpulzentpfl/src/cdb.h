...
/*** DECLARATION *************************************************************/
 ...
 extern "C" { 
  #ifndef __S390IBM__
  bool OpenDb( const char *spDatabase );
  bool CloseDb( void );
  bool ConnectDb( const char *spDatabase );
  #else  
  bool OpenDb( const char *spDatabase, char *spSsid );
 ...
 #else
  #ifndef __S390IBM__
  extern bool OpenDb( const char *spDatabase );
  extern bool CloseDb( void );
  extern bool ConnectDb( const char *spDatabase );
  #else
